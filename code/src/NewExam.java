...
public class NewExam {
    ...
    public static List<String> generateFractionMathQuiz() {
        ...
        while (count < NUM_OF_QUESTIONS) {
            ...
            String question = count + "." + a + "/" + b + " " + operator + " " + c + "/" + d + " = " + Calculation.answer;

            questions.add(question);
            if (count + NUM_OF_QUESTIONS < 9) {
                answer.append("0");
                test.append("0");
            }
            answer.append((count + 1 + NUM_OF_QUESTIONS) + ".  " + Calculation.answer + "\n");
            test.append((count + 1 + NUM_OF_QUESTIONS) + ".  " + a + "/" + b + " " + operator + " " + c + "/" + d + " = " + "\n");
            count++;
        }
        return questions;
